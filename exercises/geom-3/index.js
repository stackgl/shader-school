...
'\n\n#pragma glslify: transform = require(' + process.env.file_scale_glsl + ')\n\n',
'void main() {',
...
function getCamera() {
  ...
  return {
    ...
    scaleVec: [ Math.exp(1.0-2.0 * (mouse.x / canvas.width)), Math.exp(2.0 * (mouse.y / canvas.height)-1.0), Math.exp(2.0 * (mouse.x / canvas.width)-1.0) ]
  }
}
