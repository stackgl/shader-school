...
'\n\n#pragma glslify: transform = require(' + process.env.file_reflect_glsl + ')\n\n',
'void main() {',
  'gl_Position = projection * view * transform(planeVec) * vec4(position, 1);',
'}'].join('\n')
  , inline: true
})(gl)
...
function getCamera() {
  ...
  return {
    ...
    planeVec: [ 1.0-2.0 * (mouse.x / canvas.width), 2.0 * (mouse.y / canvas.height)-1.0, 1.0 ]
  }
}
